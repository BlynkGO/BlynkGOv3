...
//----------------------------------------------------------------------------
  ...
  namespace colors  // Colour enumeration
  {
    ...
    static constexpr int _TFT_NAVY        = 0x000F;      /*   0,   0, 128 */
    static constexpr int _TFT_DARKGREEN   = 0x03E0;      /*   0, 128,   0 */
    static constexpr int _TFT_DARKCYAN    = 0x03EF;      /*   0, 128, 128 */
    static constexpr int _TFT_MAROON      = 0x7800;      /* 128,   0,   0 */
    static constexpr int _TFT_PURPLE      = 0x780F;      /* 128,   0, 128 */
    static constexpr int _TFT_OLIVE       = 0x7BE0;      /* 128, 128,   0 */
    static constexpr int _TFT_LIGHTGREY   = 0xD69A;      /* 211, 211, 211 */
    static constexpr int _TFT_LIGHTGRAY   = 0xD69A;      /* 211, 211, 211 */
    static constexpr int _TFT_DARKGREY    = 0x7BEF;      /* 128, 128, 128 */
    static constexpr int _TFT_DARKGRAY    = 0x7BEF;      /* 128, 128, 128 */
    static constexpr int _TFT_BLUE        = 0x001F;      /*   0,   0, 255 */
    static constexpr int _TFT_GREEN       = 0x07E0;      /*   0, 255,   0 */
    static constexpr int _TFT_CYAN        = 0x07FF;      /*   0, 255, 255 */
    static constexpr int _TFT_RED         = 0xF800;      /* 255,   0,   0 */
    static constexpr int _TFT_MAGENTA     = 0xF81F;      /* 255,   0, 255 */
    static constexpr int _TFT_YELLOW      = 0xFFE0;      /* 255, 255,   0 */
    static constexpr int _TFT_WHITE       = 0xFFFF;      /* 255, 255, 255 */
    static constexpr int _TFT_ORANGE      = 0xFDA0;      /* 255, 180,   0 */
    static constexpr int _TFT_GREENYELLOW = 0xB7E0;      /* 180, 255,   0 */
    static constexpr int _TFT_PINK        = 0xFE19;      /* 255, 192, 203 */ //Lighter pink, was 0xFC9F
    static constexpr int _TFT_BROWN       = 0x9A60;      /* 150,  75,   0 */
    static constexpr int _TFT_GOLD        = 0xFEA0;      /* 255, 215,   0 */
    static constexpr int _TFT_SILVER      = 0xC618;      /* 192, 192, 192 */
    static constexpr int _TFT_SKYBLUE     = 0x867D;      /* 135, 206, 235 */
    static constexpr int _TFT_VIOLET      = 0x915C;      /* 180,  46, 226 */
    static constexpr int _TFT_TRANSPARENT = 0x0120;
  }
...
//----------------------------------------------------------------------------
  ...
  namespace textdatum
  {
    ...
    static constexpr textdatum_t _TL_DATUM   = textdatum_t::top_left;
    static constexpr textdatum_t _TC_DATUM   = textdatum_t::top_center;
    static constexpr textdatum_t _TR_DATUM   = textdatum_t::top_right;
    static constexpr textdatum_t _ML_DATUM   = textdatum_t::middle_left;
    static constexpr textdatum_t _CL_DATUM   = textdatum_t::middle_left;
    static constexpr textdatum_t _MC_DATUM   = textdatum_t::middle_center;
    static constexpr textdatum_t _CC_DATUM   = textdatum_t::middle_center;
    static constexpr textdatum_t _MR_DATUM   = textdatum_t::middle_right;
    static constexpr textdatum_t _CR_DATUM   = textdatum_t::middle_right;
    static constexpr textdatum_t _BL_DATUM   = textdatum_t::bottom_left;
    static constexpr textdatum_t _BC_DATUM   = textdatum_t::bottom_center;
    static constexpr textdatum_t _BR_DATUM   = textdatum_t::bottom_right;
    static constexpr textdatum_t _L_BASELINE = textdatum_t::baseline_left;
    static constexpr textdatum_t _C_BASELINE = textdatum_t::baseline_center;
    static constexpr textdatum_t _R_BASELINE = textdatum_t::baseline_right;
  };
