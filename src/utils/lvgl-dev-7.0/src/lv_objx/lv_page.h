...
typedef struct
{
    ...
    struct
    {
        ...
        uint8_t hor_show : 1;   /* TridentTD : เมื่อ mode == LV_SB_MODE_ON ให้ซ่อนหรือแสดง horizontal scrollbar ไหม */
        uint8_t ver_show : 1;   /* TridentTD : เมื่อ mode == LV_SB_MODE_ON ให้ซ่อนหรือแสดง vertical scrollbar ไหม */
    } sb;
#if LV_USE_ANIMATION
    struct
    {
