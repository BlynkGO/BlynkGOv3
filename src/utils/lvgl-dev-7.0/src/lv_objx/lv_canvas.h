...
// TridentTD
/**
 * Draw a line_aa on the canvas
 * @param canvas pointer to a canvas object
 * @param p1, p2 are points of the line
 * @param style style of the line (`line.width, line.color` properties are used)
 */
void lv_canvas_draw_line_aa(lv_obj_t * canvas, lv_pointf_t p1, lv_pointf_t p2, const lv_style_t * style);
