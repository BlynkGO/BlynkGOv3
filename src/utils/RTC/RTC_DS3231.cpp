...
void RTC_DS3231::set(time_t timestamp){
  DateTime dt = DateTime(timestamp);
  this->adjust(dt);
}

void RTC_DS3231::set(uint8_t day, uint8_t month, uint16_t year, uint8_t hour, uint8_t minute, uint8_t second){
