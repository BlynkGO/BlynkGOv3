...
#include <stdint.h>
#include "littlevgl_font_config.h" 
#include "esp32_memory.h"  //TridentTD
...
#  define LV_MEM_CUSTOM_ALLOC   esp32_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    esp32_free         /*Wrapper to free*/
...
#  define LV_MEM_CUSTOM_REALLOC   esp32_realloc           /*Wrapper to realloc*/
 ...
 */
#  define LV_LOG_LEVEL    LV_LOG_LEVEL_TRACE //LV_LOG_LEVEL_WARN
