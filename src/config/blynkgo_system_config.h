...
//------------------------------------------------
  ...
  #define BLYNKGO_BOARD_NAME      "BeeNeXT 2.8\" Touch (capacitive)"
  #define BLYNKGO_BASIC
  #define OFFSET_ROTATION         0
  #define ROTATE_TYPE             3
  #define BEENEXT
...
//  Board Selection
//
//    เลือกบอร์ด อย่างใดอย่างหนึ่ง 
//    โดยการเอา // หน้าบรรทัดออกเฉพาะบอร์ดที่ใช้งานเพียง แบบเดียว
//    และบอร์ดไหนไม่ได้ใช้ ให้ใส่ // หน้าบรรทัด ให้เหลือเพียงบอร์ดเดียว
//
//    *****   Select ONLY ONE board *****
//--------------------------------------------------------

/* BlynkGO Board V1.1-V1.3  (ESP32 TFT Touch 3.5 capacitive with Camera รุ่นพิเศษ Flash 16MB PSRAM 8MB ) */
// #define BLYNKGO_BOARD_V1_3

/* BlynkGO BOard S3 Parallel (ESP32-S3 TFT Touch 3.5 capacitive Parallel , Flash 16MB PSRAM 2MB)
// #define BLYNKGO_BOARD_S3_PARALLEL

/* BlynkGO EMMA II  (ESP32 TFT Touch 3.5 capacitive with Flash 16MB PSRAM 8MB ) */
// #define BLYNKGO_EMMA_II

/* BlynkGO EMMA III RS485  (ESP32S3 TFT Touch 3.5 capacitive Parallel with 485 ) */
// #define BLYNKGO_EMMA_PRO

/* BlynkGO Enterprise 4.3" RS485 : TFT 4.3 inches RS485 touch screen */
// #define BLYNKGO_ENTERPRISE_4_3_INCH

/* BlynkGO Enterprise 5" : TFT 5 inches capacitive touch screen */
// #define BLYNKGO_ENTERPRISE_5_0_INCH

/* BlynkGO Enterprise 7" : TFT 7 inches capacitive touch screen */
// #define BLYNKGO_ENTERPRISE_7_0_INCH

/* BlynkGO ESP32 DevBoard */
// #define BLYNKGO_ESP32DEVBOARD_OLED_SSD1306
// #define BLYNKGO_ESP32DEVBOARD_OLED_SH1106
// #define BLYNKGO_ESP32DEVBOARD_TFT_2_4_INCH
// #define BLYNKGO_ESP32DEVBOARD_TFT_2_8_INCH
// #define BLYNKGO_ESP32DEVBOARD_TFT_3_2_INCH
// #define BLYNKGO_ESP32DEVBOARD_TFT_3_5_INCH
// #define BLYNKGO_ESP32DEVBOARD_TFT_4_0_INCH

// #define LOLIN_D32_PRO_OLED_SSD1306
// #define LOLIN_D32_PRO_OLED_SH1106
