...
#define DHT_PIN   25              // กำหนดขา pin ที่ต่อ DHT
...
void setup(){
  ...
  gauge_temp.thickness(15);
  gauge_temp.range(20,80);
  gauge_temp.range_color(TFT_ORANGE);
  ...
  gauge_humid.thickness(15);
  gauge_humid.range(0,100);
  gauge_humid.range_color(TFT_CYAN);
