...
void setup(){
  ...
  ta_speed.corner_radius(RADIUS_CIRCLE);
  ta_speed.font_color(TFT_BLACK);
  ta_speed.padding_left_right(20);
  ta_speed.border(1,TFT_BLACK);
  ta_speed.border_opa(30);
  ...
  ta_volt.corner_radius(RADIUS_CIRCLE);
  ta_volt.font_color(TFT_BLACK);
  ta_volt.padding_left_right(20);
  ta_volt.border(1,TFT_BLACK);
  ta_volt.border_opa(30);
