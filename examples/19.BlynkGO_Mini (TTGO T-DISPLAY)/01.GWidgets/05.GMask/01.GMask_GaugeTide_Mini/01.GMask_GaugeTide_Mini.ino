...
FONT_DECLARE(BebasNeueBold_num_35);
...
void gauge_create(){
  ...
  lb_value.font(BebasNeueBold_num_35, TFT_BLACK);
  lb_value.align(ALIGN_CENTER,0,-8);
  
  lb_gauge_title.font(prasanmit_25, TFT_BLACK);
  lb_gauge_title.align(lb_value, ALIGN_BOTTOM,0,-8);
