...
void WaterTank_create(GWidget&parent){
  ...
  cont_watertank.align(ALIGN_LEFT,15);
  cont_watertank.dragable(true);
  ...
  lb_water_volume.align(ALIGN_TOP_RIGHT, -45, lb_water_info.bottomY());
