/********************************************************************
 * ตัวอย่าง การสร้าง Joystick 
 * ที่สามารถควบคุมได้จาก TFT และ แอพ Blynk
 * --------------------------------------------
 * ที่แอพ Blynk ให้สร้าง Widget Joystick สีแดง 
 * โดยกำหนด 
 *   output      : MERGE
 *   virtual pin : V9 
 *        [0]    : 0-1023
...
void setup() {
  ...
  joystick.virtualPin(V9);  // เชื่อมโยงข้อมูลกับแอพ Blynk ผ่านทาง virtual pin V9

  // หากมีการเปลี่ยนแปลงค่า ไม่ว่าจาก TFT หรือ แอพ Blynk เข้ามา
  joystick.onValueChanged([](GWidget* widget){
    // แสดง x,y ของ Joystick ออก serial monitor
...
// รับค่า Joystick จากแอพ Blynk มากำหนดให้ joystick ของ BlynkGO
BLYNK_WRITE(V9){
  joystick.setXY(param[0].asInt(), param[1].asInt());
}
