/*******************************************************************
 * Framework แบบ DockMenu 
 *   - DockMenu สร้างด้วย วิตเจ็ต GPage 
 *    และมีปุ่มกด สร้างด้วยรูปภาพ ด้วย วิตเจ็ต GImageButton
 *    เพื่อทำการเปิดพื้นที่ใหม่ๆ ขึ้นมาได้ตามต้องการ
 *    
 *   - DockMenu สามารถเรียกขึ้นมาได้โดยการกดปุ่มเมนูที่ขวาบน
 *     หรือ จะปาดนิ้วขึ้น ก็ได้ และสามารถซ่อนอัตโนมัติ 
